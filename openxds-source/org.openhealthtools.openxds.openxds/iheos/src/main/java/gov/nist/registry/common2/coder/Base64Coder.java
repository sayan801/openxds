package gov.nist.registry.common2.coder;
...
//	InputStream f_in = new FileInputStream("/Users/bill/ihe/testing/sha1/utf8ccds/test3.xml");
...
public static boolean isUsAscii(byte[] in) {
	return !bit8(in);
}

public static boolean bit8(byte[] in) {
