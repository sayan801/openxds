package gov.nist.registry.ws.sq.test.getDocuments;
...
public class BasicGetDocuments extends TestBase {
	FindDocsTestData testdata;
	
	public BasicGetDocuments() throws Exception {
		super();
	...
	public void basicObjectRefQuery() throws Exception {
		...
		Metadata results = eFact.GetDocuments(sqs);
