package gov.nist.registry.ws.sq.test.getAssoc;
...
public class BasicGetAssoc extends TestBase {
	
	FindSSTestData testdata;

	public BasicGetAssoc() throws Exception {
		super();
	...
	public void basicObjectRefQuery() throws Exception {
		...
		Metadata results = eFact.GetAssociations(sqs);
