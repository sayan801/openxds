-- SDS-5671 + SDS-5672
alter table documententries add column IF NOT EXISTS deletetrigger_time datetime(6) generated always as (COALESCE(servicestarttime, creation_time)) PERSISTENT;
